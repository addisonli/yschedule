...
public class TBScheduleManagerFactory implements ApplicationContextAware {
	...
	private Map<String, TBScheduleManager> managerMap = new HashMap<String, TBScheduleManager>();
	/**
	 * 告警接口
	 */
	...
	public TBScheduleManager createTBScheduleManager(String taskType,String ownSign)
		...
		TBScheduleManager result = new TBScheduleManager(this,taskType,ownSign,managerPort, jmxUrl, scheduleConfigCenter,
		...
		managerMap.put(taskType+"$"+ownSign+"$"+result.hashCode(), result);
		return result;
	}
	...
	public void unregister(TBScheduleManager manager) throws Exception{
		TBScheduleManagerFactory.unregisterMBean(manager.getmBeanName());
