...
public class TBScheduleManager {
	...
	TBScheduleManager(TBScheduleManagerFactory aFactory,String baseTaskType,String ownSign,int managerPort,String jxmUrl,IScheduleConfigCenterClient aScheduleCenter,IScheduleTaskDeal aQueueDealTask,IScheduleAlert aScheduleAlert) throws Exception{
